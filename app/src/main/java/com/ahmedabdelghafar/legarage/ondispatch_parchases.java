...
public class ondispatch_parchases extends Activity implements Download_data.download_complete {
    public ListView listView;
    public ArrayList<Countries> countries = new ArrayList<Countries>();
    public List_Adapter_ondispatch_parchases adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ondispatch_parchases);

        pd = new ProgressDialog(ondispatch_parchases.this);
        ...
        textviewaddress.setText("تحت التجهيز للشحن");

        listView = (ListView) findViewById(R.id.ListView_ondispatch_parchases);
        adapter = new List_Adapter_ondispatch_parchases(this);
...
*/
        ...
        swipeContainer = (SwipeRefreshLayout) findViewById(R.id.swiperefresh_ondispatch_parchases);
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                SharedPreferences sharedPreferences = getSharedPreferences("Data", Context.MODE_PRIVATE);
                Download_data download_data = new Download_data((Download_data.download_complete) ondispatch_parchases.this);
                download_data.download_data_from_link("http://197.51.253.242:3000/api/showdataonlocationparchases/"+getIntent().getStringExtra("menu_id") +","+ sharedPreferences.getString("seller_id", "0"));
    ...
    public void onBackPressed() {
        Intent i = new Intent(ondispatch_parchases.this, menu_parchases.class);
        //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
        startActivity(i);
    }
