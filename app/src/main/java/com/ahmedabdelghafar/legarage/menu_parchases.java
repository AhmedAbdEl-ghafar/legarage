...
public class menu_parchases extends AppCompatActivity implements Download_data.download_complete {
    public ListView listView;
    public ArrayList<Countries> countries = new ArrayList<Countries>();
    public List_Adapter_menu_parchases adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_parchases);


        toolbar = (Toolbar) findViewById(R.id.toolbarss_sales);
        setSupportActionBar(toolbar);

        mDrawerLayout = (DrawerLayout)findViewById(R.id.drawerLayout_2_parchases);
...
*/
        ...
        pd = new ProgressDialog(menu_parchases.this);
        pd.setMessage("Please Wait To Load Data");
        pd.setIndeterminate(true);
        pd.setProgress(0);
        pd.show();

        listView = (ListView) findViewById(R.id.ListView_menu_parchases);
        adapter = new List_Adapter_menu_parchases(this);
        ...
        download_data.download_data_from_link("http://197.51.253.242:3000/api/menu_app_parchases/"+sharedPreferences.getString("seller_id", "0"));
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.menu1:
                        Intent isw = new Intent(menu_parchases.this, Home.class);
                        startActivity(isw);
                        break;

                    case R.id.menu2:
                        Intent isw23 = new Intent(menu_parchases.this, reciving_notification.class);
                        startActivity(isw23);
                        //Toast.makeText(menu_parchases.this, "هذه الصفحة تحت التطوير", Toast.LENGTH_LONG).show();
                        break;
                    ...
                    case R.id.menu4:
                        ...
                        if (ActivityCompat.checkSelfPermission(menu_parchases.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            Toast.makeText(menu_parchases.this,"Please grant the  permission to call",Toast.LENGTH_SHORT).show();
                            requestPermission();
                        }
                        else {
                            startActivity(i);
                    ...
                    case R.id.menu5:
                        // Intent is = new Intent(MainActivity.this, Home.class);
                        //startActivity(is);
                        Intent iss = new Intent(menu_parchases.this, menu_m.class);
                        startActivity(iss);
                        break;
                    ...
                    case R.id.menu10:
                        try {
                            ...
                            Intent iswe = new Intent(menu_parchases.this, MainActivity.class);
                            startActivity(iswe);
                        ...
                        Toast.makeText(menu_parchases.this, "برجاء تشغيل البرنامج مرة اخري", Toast.LENGTH_LONG).show();
                        break;
                                                ...
                                                switch (selected.toString()) {
                                                    case "5":
                                                        switch (sum_sum.toString()) {
                                                            case "0":
                                                                Toast.makeText(menu_parchases.this, "لا توجد بيانات لكي يتم عرضها", Toast.LENGTH_LONG).show();
                                                                break;
                                                            default:
                                                                Intent i = new Intent(menu_parchases.this, successful_parchases.class);
                                                    ...
                                                    case "10":
                                                        switch (sum_sum.toString()) {
                                                            ...
                                                            default:
                                                                ...
                                                                Intent i2 = new Intent(menu_parchases.this, ondispatch_parchases.class);
                                                                ////// //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
                                                    ...
                                                    case "15":
                                                        switch (sum_sum.toString()) {
                                                            ...
                                                            default:
                                                                //Toast.makeText(menu_m.this, "4", Toast.LENGTH_LONG).show();
                                                                Intent i2 = new Intent(menu_parchases.this, readyshipmentparchases.class);
                                                                ////// //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
                                                                i2.putExtra("menu_id", selected.toString());
                                                                /////////i.putExtra("G_Code",selected.toString());
                                                                startActivity(i2);
                                                    ...
                                                    case "20":
                                                        switch (sum_sum.toString()) {
                                                            ...
                                                            default:
                                                                //Toast.makeText(menu_m.this, "4", Toast.LENGTH_LONG).show();
                                                                Intent i2 = new Intent(menu_parchases.this, ondeliveryparchases.class);
                                                                ////// //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
                                                                i2.putExtra("menu_id", selected.toString());
                                                                /////////i.putExtra("G_Code",selected.toString());
                                                                startActivity(i2);
                                                    ...
                                                    case "25":
                                                        switch (sum_sum.toString()) {
                                                            ...
                                                            default:
                                                                //Toast.makeText(menu_m.this, "4", Toast.LENGTH_LONG).show();
                                                                Intent i2 = new Intent(menu_parchases.this, onnowparchases.class);
                                                                ////// //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
                                                                i2.putExtra("menu_id", selected.toString());
                                                                /////////i.putExtra("G_Code",selected.toString());
                                                                startActivity(i2);
                                                    ...
                                                    case "30":
                                                        switch (sum_sum.toString()) {
                                                            ...
                                                            default:
                                                                //Toast.makeText(menu_m.this, "4", Toast.LENGTH_LONG).show();
                                                                Intent i2 = new Intent(menu_parchases.this, oldparchases.class);
                                                                ////// //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
                                                                i2.putExtra("menu_id", selected.toString());
                                                                /////////i.putExtra("G_Code",selected.toString());
                                                                startActivity(i2);
                                                    ...
                                                    case "16":
                                                        switch (sum_sum.toString()) {
                                                            ...
                                                            default:
                                                                //Toast.makeText(menu_m.this, "4", Toast.LENGTH_LONG).show();
                                                                Intent i2 = new Intent(menu_parchases.this, ondelivery.class);
                                                                ////// //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
                                                                i2.putExtra("menu_id", selected.toString());
                                                                /////////i.putExtra("G_Code",selected.toString());
                                                                startActivity(i2);
                                                    ...
                                                    case "80":
                                                        switch (sum_sum.toString()) {
                                                            ...
                                                            default:
                                                                //Toast.makeText(menu_m.this, "4", Toast.LENGTH_LONG).show();
                                                                Intent i2 = new Intent(menu_parchases.this, dondelivery.class);
                                                                ////// //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
                                                                i2.putExtra("menu_id", selected.toString());
                                                                /////////i.putExtra("G_Code",selected.toString());
                                                                startActivity(i2);
                                                    ...
                                                    case "21":
                                                        switch (sum_sum.toString()) {
                                                            ...
                                                            default:
                                                                //Toast.makeText(menu_m.this, "4", Toast.LENGTH_LONG).show();
                                                                Intent i2 = new Intent(menu_parchases.this, nodelivery.class);
                                                                ////// //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
                                                                i2.putExtra("menu_id", selected.toString());
                                                                /////////i.putExtra("G_Code",selected.toString());
                                                                startActivity(i2);
                                                    ...
                                                    case "22":
                                                        switch (sum_sum.toString()) {
                                                            ...
                                                            default:
                                                                //Toast.makeText(menu_m.this, "4", Toast.LENGTH_LONG).show();
                                                                Intent i2 = new Intent(menu_parchases.this, avilabel.class);
                                                                ////// //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
                                                                i2.putExtra("menu_id", selected.toString());
                                                                /////////i.putExtra("G_Code",selected.toString());
                                                                startActivity(i2);
                                                    ...
                                                    case "24":
                                                        switch (sum_sum.toString()) {
                                                            ...
                                                            default:
                                                                //Toast.makeText(menu_m.this, "4", Toast.LENGTH_LONG).show();
                                                                Intent i2 = new Intent(menu_parchases.this, endss.class);
                                                                ////// //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
                                                                i2.putExtra("menu_id", selected.toString());
                                                                /////////i.putExtra("G_Code",selected.toString());
                                                                startActivity(i2);
...
*/
        ...
        swipeContainer = (SwipeRefreshLayout) findViewById(R.id.swiperefresh_menu_parchases);
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                SharedPreferences sharedPreferences = getSharedPreferences("Data", Context.MODE_PRIVATE);
                Download_data download_data = new Download_data((Download_data.download_complete) menu_parchases.this);
                download_data.download_data_from_link("http://197.51.253.242:3000/api/menu_app_parchases/"+sharedPreferences.getString("seller_id", "0"));
    ...
    public void onBackPressed() {
        Intent i = new Intent(menu_parchases.this, Home.class);
        //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
        startActivity(i);
    }
        ...
        if(mtoggle.onOptionsItemSelected(item)){
            switch (item.getItemId()) {
                ...
                case R.id.menu5:
                    ...
                    Intent is = new Intent(menu_parchases.this, menu_m.class);
                    startActivity(is);
                    break;
                ...
                case R.id.menu2:
                    // Intent is = new Intent(MainActivity.this, Home.class);
                    //startActivity(is);
                    Toast.makeText(menu_parchases.this, "test 4", Toast.LENGTH_LONG).show();
                    break;
