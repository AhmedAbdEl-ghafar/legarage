...
public class List_Adapter_ondeliveryparchases extends BaseAdapter {
    ondeliveryparchases ondeliveryparchases_view;


    List_Adapter_ondeliveryparchases(ondeliveryparchases ondeliveryparchases_view) { this.ondeliveryparchases_view = ondeliveryparchases_view;}

    @Override
    public int getCount() {
        return ondeliveryparchases_view.countries.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        List_Adapter_ondeliveryparchases.ViewHolderItem holder = new List_Adapter_ondeliveryparchases.ViewHolderItem();
        if (convertView == null) {
            LayoutInflater inflater = (LayoutInflater) ondeliveryparchases_view.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.cell_ondeliveryparchases, null);
            ...
            holder.imagess_flogss = (ImageView) convertView.findViewById(R.id.imagess_flog_ondeliveryparchases);
           ...
           */ //holder.dr_receiving = (TextView) convertView.findViewById(R.id.dr_receiving);
            ...
            holder = (List_Adapter_ondeliveryparchases.ViewHolderItem) convertView.getTag();
        }


        holder.id_order.setText(this.ondeliveryparchases_view.countries.get(position).id_order);
        holder.ddate.setText(this.ondeliveryparchases_view.countries.get(position).ddate);
        holder.discreption.setText(this.ondeliveryparchases_view.countries.get(position).discreption);
        holder.url.setText(this.ondeliveryparchases_view.countries.get(position).url);
...
//If the edit text contains previous text with potential links
        ...
        holder.price.setText(this.ondeliveryparchases_view.countries.get(position).price);
        Glide.with(ondeliveryparchases_view.getApplicationContext()).load(this.ondeliveryparchases_view.countries.get(position).imagessflog).into(holder.imagess_flogss);
