...
public class revision extends Activity implements Download_data.download_complete {
    public ListView listView;
    public ArrayList<Countries> countries = new ArrayList<Countries>();
    public List_Adapter_revision adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(revision.this);
        ...
        textviewaddress.setText("المراجعة");

        listView = (ListView) findViewById(R.id.ListView_revision);
        adapter = new List_Adapter_revision(this);
...
*/
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                SharedPreferences sharedPreferences = getSharedPreferences("Data", Context.MODE_PRIVATE);
                Download_data download_data = new Download_data((Download_data.download_complete) revision.this);
                download_data.download_data_from_link("http://197.51.253.242:3000/api/showdataonlocation/"+getIntent().getStringExtra("menu_id") +","+ sharedPreferences.getString("seller_id", "0"));
    ...
    public void onBackPressed() {
        Intent i = new Intent(revision.this, menu_m.class);
        //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
        startActivity(i);
    }
