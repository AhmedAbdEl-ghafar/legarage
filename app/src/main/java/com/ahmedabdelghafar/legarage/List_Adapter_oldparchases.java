...
public class List_Adapter_oldparchases extends BaseAdapter {
    oldparchases oldparchases_view;


    List_Adapter_oldparchases(oldparchases oldparchases_view) { this.oldparchases_view = oldparchases_view;}

    @Override
    public int getCount() {
        return oldparchases_view.countries.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        List_Adapter_oldparchases.ViewHolderItem holder = new List_Adapter_oldparchases.ViewHolderItem();
        if (convertView == null) {
            LayoutInflater inflater = (LayoutInflater) oldparchases_view.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.cell_oldparchases, null);
           ...
           */ //holder.dr_receiving = (TextView) convertView.findViewById(R.id.dr_receiving);
            ...
            holder = (List_Adapter_oldparchases.ViewHolderItem) convertView.getTag();
        }


        holder.id_order.setText(this.oldparchases_view.countries.get(position).id_order);
        holder.ddate.setText(this.oldparchases_view.countries.get(position).ddate);
        holder.discreption.setText(this.oldparchases_view.countries.get(position).discreption);
        holder.url.setText(this.oldparchases_view.countries.get(position).url);
...
//If the edit text contains previous text with potential links
        ...
        holder.price.setText(this.oldparchases_view.countries.get(position).price);
