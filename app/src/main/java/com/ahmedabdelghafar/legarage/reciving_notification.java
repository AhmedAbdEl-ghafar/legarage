...
public class reciving_notification extends Activity implements Download_data.download_complete {
    public ListView listView;
    public ArrayList<Countries> countries = new ArrayList<Countries>();
    public List_Adapter_reciving_notification adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reciving_notification);
        pd = new ProgressDialog(reciving_notification.this);
        ...
        textviewaddress.setText("الإشعارات");

        listView = (ListView) findViewById(R.id.ListView_receiving);
        adapter = new List_Adapter_reciving_notification(this);
        listView.setAdapter(adapter);

        SharedPreferences sharedPreferences = getSharedPreferences("Data", Context.MODE_PRIVATE);

        Download_data download_data = new Download_data((Download_data.download_complete) this);
        download_data.download_data_from_link("http://197.51.253.242:3000/api/recivingnotif/"+ sharedPreferences.getString("seller_id", "0"));
...
*/
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                SharedPreferences sharedPreferences = getSharedPreferences("Data", Context.MODE_PRIVATE);
                Download_data download_data = new Download_data((Download_data.download_complete) reciving_notification.this);
                download_data.download_data_from_link("http://197.51.253.242:3000/api/recivingnotif/"+ sharedPreferences.getString("seller_id", "0"));
    ...
    public void onBackPressed() {
        Intent i = new Intent(reciving_notification.this, Home.class);
        //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
        startActivity(i);
    }
...
//                DateTimeFormatter formatter = DateTimeFormat.forPattern("dd/MM/yyyy HH:mm:ss");
                ...
                add.notification = obj.getString("notification");
