...
public class avilabel extends Activity implements Download_data.download_complete {
    public ListView listView;
    public ArrayList<Countries> countries = new ArrayList<Countries>();
    public List_Adapter_avilabel adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_avilabel);

        pd = new ProgressDialog(avilabel.this);
        ...
        textviewaddress.setText("جاهزة للتحصيل");

        listView = (ListView) findViewById(R.id.ListView_avilabel);
        adapter = new List_Adapter_avilabel(this);
...
*/
        ...
        swipeContainer = (SwipeRefreshLayout) findViewById(R.id.swiperefresh_avilabel);
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                SharedPreferences sharedPreferences = getSharedPreferences("Data", Context.MODE_PRIVATE);
                Download_data download_data = new Download_data((Download_data.download_complete) avilabel.this);
                download_data.download_data_from_link("http://197.51.253.242:3000/api/showdataonlocation/"+getIntent().getStringExtra("menu_id") +","+ sharedPreferences.getString("seller_id", "0"));
    ...
    public void onBackPressed() {
        Intent i = new Intent(avilabel.this, menu_m.class);
        //i.putExtra("dr_no",getIntent().getStringExtra("dr_no"));
        startActivity(i);
    }
    public void get_data(String data)
    {
        ...
        try {
            ...
            for (int i = 0 ; i < data_array.length() ; i++)
            {
                ...
                add.commission_value = obj.getString("commission_value");
                add.display_expenses = obj.getString("display_expenses");
                add.net = obj.getString("net");
